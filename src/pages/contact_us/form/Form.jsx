    ...
    <Container fluid className={styles.Container}>
      <section className="mb-5">
        ...
        <Row className="gap-5 mt-5 mx-auto d-flex align-items-center justify-content-center">
          {/*card 1*/}
          <Col lg="4" md="6" className={styles.card}>
            <BsFillPhoneVibrateFill className={styles.icon} />

            <h3 className={styles.headingsmall}>PHONE</h3>

            <p className={styles.text}>+234(09)277-455-900</p>

            <p className={styles.text}>+234(09)277-800-900</p>
          </Col>
          ...
          <Col lg="4" md="6" className={styles.card}>
            ...
            <h3 className={styles.headingsmall}>Email</h3>

            <p className={styles.text}>bennyfoodiesupport@gmail.com</p>
            <p className={styles.text}>bennyfoodiehelpline@gmail.com</p>
          </Col>

          {/*card 3*/}
          <Col lg="4" md="6" className={styles.card}>
            <MdLocationOn className={styles.icon} />
            <h3 className={styles.headingsmall}>address</h3>
            <p className={styles.text}>No 15 Jonnesburg Street Ikoyi, Lagos</p>
          </Col>
        </Row>
      </section>
      ...
      <Form onSubmit={handlesubmit} className={styles.form}>
        <h1 className="mb-3">
          ...
          OR <div className={styles.line}></div>
        </h1>
