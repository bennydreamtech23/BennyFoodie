...
const FavouriteFoodSection = () => {
  ...
  return (
    <Container fluid className={FavouriteFoodStyles.Container}>
      <h1 className={FavouriteFoodStyles.favouriteFoodTitle}>
      ...
      <Row className="gap-5 mt-5 d-flex align-items-center justify-content-center">
        {favouritefoodData.map((item) => (
          <Col key={item.id} xl="3" lg="3" md="5">
            <ProductCard item={item} className={FavouriteFoodStyles.card} />
          </Col>
        ))}
      </Row>
    </Container>
