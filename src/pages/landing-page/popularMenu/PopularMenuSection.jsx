...
const PopularMenuSection = (props) => {
  const chefanime =
    "https://res.cloudinary.com/dlst0ec4h/image/upload/v1673719201/pngwing.com-_1__ls7bfm.webp";
  ...
  return (
    <>
      <Row className="bg-container d-flex align-items-center justify-content-between">
        <Col lg="6" md="12">
          <h1 className="popularTitle">Our Popular Menu</h1>

          <p className="subHeading">
            We always strive to prepare our Dishes with love and care, ensuring
            that our Customers remain healthy and happy.
          </p>
        </Col>

        <Col lg="6" md="12" className="column">
          <img src={chefanime} loading="lazy" className="Img" />
        </Col>
      </Row>

      <Container fluid className="popularFoodContainer">
        ...
        <Row className="d-flex align-items-center justify-content-center gap-5">
          <Col className="d-flex flex-column align-items-center justify-content-center">
            ...
            >
              <MdOutlineFastfood className="lead" />
              All
            </button>
          </Col>
          ...
          <Col className="d-flex flex-column align-items-center justify-content-center">
            <button
              ...
              className="foodBtnActive d-flex align-items-center justify-content-center gap-2"
            >
              <MdOutlineFreeBreakfast className="lead" />
              Breakfast
            </button>
          </Col>
          ...
          <Slider {...settings} className="mt-3">
            {menu.map((item) => (
              <Col xl="3" lg="5" md="5" sm="5" className="mb-5" key={item.id}>
                <ProductCard
                  item={item}
                  className="card"
