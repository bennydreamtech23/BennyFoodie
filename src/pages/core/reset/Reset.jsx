...
navigate('/signup')
  ...
  .matches(/[a-zA-Z]/, 'new Password can only contain Latin letters.'),
...
Password
  ...
  <InputGroup className={styles.inputField}>
       ...
       {formik.touched.confirmPassword && formik.errors.confirmPassword ? (
             <div className={styles.errorMsg}><MdErrorOutline className="h6 mt-1"/> {formik.errors.confirmPassword}</div>
           ) : null}         
